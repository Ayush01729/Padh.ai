    ...
    <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
      <div className="card text-dark bg-light mb-3">
        <div className="card-modal-front">
          <div className="card-header border-0">{data.subject}</div>
      ...
      >
        ...
        <div className="card-body">
          ...
          <div className="card-text fs-5">
            ...
            <b>
              {selectedOptionId +
                ") " +
                (selectedOptionId &&
                  data.options.filter((obj) => obj.id === selectedOptionId)[0]
                    .text)}{" "}
            </b>
          </div>
          <br />
          <div className="card-text fs-5">
            ...
            <b>
              {data.answer_id +
                ") " +
                data.options.filter((obj) => obj.id === data.answer_id)[0].text}
            </b>
          </div>
          <br />
        ...
        <div className="card-footer">
          <Stack gap={2}>
            ...
            <Button className="w-100" variant="primary" onClick={handleClick}>
              Next Question
            </Button>
          </Stack>
        </div>
